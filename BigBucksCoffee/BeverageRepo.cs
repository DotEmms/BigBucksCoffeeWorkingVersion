...
namespace BigBucksCoffee
{
    public class BeverageRepo : IBeverageRepo
    {
            ...
            var drinks = new List<IBeverage>
        {
            ...
            new Smoothie(4,"Morning smoothie","Strawberry Banana", 6.99,@"Images\coffee2.jpg",true,true,true),
            new Soda(5, "Fanta orange","Fanta orange", 2.5,@"Images\coffee2.jpg",false,true,false),
        };
